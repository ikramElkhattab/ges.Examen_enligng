...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           // Associez chaque examen à un étudiant avant de les sauvegarder
            examens.get(0).setEtudiant(etudiants.get(0)); // Associe le premier examen au premier étudiant
            examens.get(1).setEtudiant(etudiants.get(1)); // Associe le deuxième examen au deuxième étudiant
            examens.get(2).setEtudiant(etudiants.get(2)); // Associe le troisième examen au troisième étudiant

// Sauvegardez les examens comme avant
            for (Examen examen : examens) {
                examenDao.create(examen);
                System.out.println("Examen créé : " + examen.getTitre() + " pour l'étudiant : " + examen.getEtudiant().getNom());
