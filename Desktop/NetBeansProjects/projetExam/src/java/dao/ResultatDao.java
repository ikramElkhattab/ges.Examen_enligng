...
public class ResultatDao implements IDao<Resultat> {
    ...
    public List<Resultat> findAll() {
        ...
        try {
            session = HibernateUtil.getSessionFactory().openSession();
            tx = session.beginTransaction();
            resultats = session.createQuery("from Resultat").list();
            tx.commit();
        } catch (HibernateException e) {
            if (tx != null) {
                tx.rollback();
    ...
    public List<Resultat> findByEtudiant(Etudiant etudiant) {
        Session session = null;
        Transaction tx = null;
        List<Resultat> resultats = null;
        try {
            ...
            Query query = session.createQuery("FROM Resultat r WHERE r.etudiant = :etudiant");
